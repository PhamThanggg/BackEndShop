			...
			<ul class="d-flex align-items-center">
				...
				<!-- End Profile Iamge Icon -->
					...
					<ul
						...
						<li class="dropdown-header"><span>ThangPham</span></li>
						<li>
							<hr class="dropdown-divider">
						</li>

						<li><a class="dropdown-item d-flex align-items-center"
							href="#"> <i class="bi bi-box-arrow-right"></i>
								<form action="LogResController" method="POST">
									<input
										style="background-color: #F6F7FB; border: unset; height: 24px"
										type="submit" name="action" value="Logout">
								</form>
						</a></li>
