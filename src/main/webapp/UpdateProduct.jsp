                ...
                <form method="post" enctype="multipart/form-data" action="updateproduct">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="txtcateid">
                            <option value="${pro.cateId}" selected>${pro.nameCate}</option>
                    ...
                    <img alt="" src="${pro.img}" style="width: 50px">
                    <div class="form-group">
                        <label for="txtpic">Url Hình ảnh</label> <input value="${pro.img}" name="imggoc">
                    ...
                    <select class="form-control" name="txtcolor">
                        <option value="${pro.color }" selected>${pro.color }</option>
                    ...
                    <div class="form-group">
                        <label for="txtprice">Người bán</label>
                        <input class="form-control" type="text" id="txtprice" name=""
                            value="${pro.nameUser }" readonly="readonly">
                    </div>
                    <div class="form-group">
                        <label for="txtprice">Đã bán</label>
                        <input class="form-control" type="text" id="txtprice" name=""
                            value="${pro.sell }" readonly="readonly">
                    </div>
                    
                    <div class="form-group">
                        <label for="txtprice">Trạng thái</label>
                        <input class="form-control" type="text" id="txtprice" name="txtstatus"
                            value="${pro.status }">
                    </div>
                    <br>
